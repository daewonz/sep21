    ...
    <form action="./atapplication" method="post" onsubmit="return check()">
        <div class="modal-content">
            ...
            <tr class="tr2">
               ...
               value="<c:if test="${sessionScope.egrade eq 0}">사원</c:if><c:if test="${sessionScope.egrade eq 1}">주임</c:if>
               <c:if test="${sessionScope.egrade eq 2}">대리</c:if><c:if test="${sessionScope.egrade eq 3}">과장</c:if>
               <c:if test="${sessionScope.egrade eq 4}">차장</c:if><c:if test="${sessionScope.egrade eq 5}">부장</c:if>
               <c:if test="${sessionScope.egrade eq 6}">부사장</c:if><c:if test="${sessionScope.egrade eq 7}">사장</c:if>" disabled></td>
            </tr>
            <tr>
