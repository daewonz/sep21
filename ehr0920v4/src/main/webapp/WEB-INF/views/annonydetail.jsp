...
<body>
	...
	<article id="article">
      ...
      <div id="detail">
         ...
         <div id="detailN_no" style="margin-left: 100%-30px;">조회수 : ${detail.abread}</div>
         <div id="detailIdDate">
            <div id="detailID">글쓴이 : ${detail.abwrite}</div>
            <div id="detailDate">${detail.abdate}</div>
         </div>
         <div id="detailContent"><p>${detail.abcontent}<br></p></div>
							...
							<div class="divTableRow">
								<c:choose>
									...
									<c:when
										...
										<div class="divTableCell" style="font-weight: bold; color: gray;" >비밀댓글입니다.</div>
									</c:when>
...
댓글이 없습니다.
		...
		<br>
			<input type="text" name="comment" class="commentcontent"
				placeholder="글쓴이 : ${commentWriter }" style="width: 80%;">
