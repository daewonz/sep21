   ...
   if(session.getAttribute("eno") != null) {
      int pageSize = 10;
         ...
         if (pageSize < 0 || pageSize > 50)
           ...
           if(totalCnt % pageSize != 0) { pageCount = pageCount+1; }
...
@GetMapping("/notice")
public String notice(Model model, HttpSession session, @RequestParam(defaultValue = "1") Integer page,  @RequestParam(defaultValue = "10") Integer pageSize) {
...
public String reportAgree(@RequestParam(value = "abno") int abno, @RequestParam(value = "rreported")int rreported) {
